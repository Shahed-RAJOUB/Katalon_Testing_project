...
WebUI.setText(findTestObject('Object Repository/Page_UiBank/input_Email Address of Requester_email'), 'chahed.rajoub.atos@gmail.com')
...
WebUI.verifyElementText(findTestObject('Page_UiBank/span_8', [('8') : '']), '8')
