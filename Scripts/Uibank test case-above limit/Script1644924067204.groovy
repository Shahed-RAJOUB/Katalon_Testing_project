...
WebUI.setText(findTestObject('Object Repository/Page_UiBank/input_Loan Amount Requested_amount'), '12000')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_UiBank/select_13510'), '5', true)

WebUI.setText(findTestObject('Object Repository/Page_UiBank/input_Current Yearly Income (Before Taxes)_income'), '3000')

WebUI.setText(findTestObject('Object Repository/Page_UiBank/input_Age_age'), '16')

WebUI.click(findTestObject('Object Repository/Page_UiBank/button_Submit Loan Application'))

WebUI.verifyElementText(findTestObject('Page_UiBank/h1_Sorry, at this time you have not been ap_e84b21'), 'Sorry, at this time you have not been approved for a loan.')
